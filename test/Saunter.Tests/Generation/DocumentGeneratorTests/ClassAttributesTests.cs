...
public class ClassAttributesTests
{
    ...
    [Fact]
    public void GenerateDocumentGeneratesDocumentWithMultipleMessagesPerChannelInTheSameMethod()
    {
        // Arrange
        AsyncApiOptions options = new();
        DocumentGenerator documentGenerator = new();
    ...
    [Fact]
    public void GenerateDocumentGeneratesDocumentWithSingleMessage()
    {
        // Arrange
        AsyncApiOptions options = new();
        DocumentGenerator documentGenerator = new();
    ...
    [Fact]
    public void GetDocumentWhenMultipleClassesUseSameChannelKeyGeneratesDocumentWithMultipleMessagesPerChannel()
    {
        // Arrange
        AsyncApiOptions options = new();
        DocumentGenerator documentGenerator = new();
    ...
    [Fact]
    public void GenerateDocumentGeneratesDocumentWithChannelParameters()
    {
        // Arrange
        AsyncApiOptions options = new();
        DocumentGenerator documentGenerator = new();
    ...
    [Fact]
    public void GenerateDocumentGeneratesDocumentWithMessageHeader()
    {
        // Arrange
        AsyncApiOptions options = new();
        DocumentGenerator documentGenerator = new();
