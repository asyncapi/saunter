...
public class SchemaGenerationTests
{
    ...
    [Fact]
    public void GenerateSchemaGenerateSchemaFromTypeWithPropertiesGeneratesSchemaCorrectly()
    {
    ...
    [Fact]
    public void GenerateSchemaGenerateSchemaFromTypeWithFieldsGeneratesSchemaCorrectly()
    {
    ...
    [Fact]
    public void GenerateSchemaGenerateSchemaFromClassWithDiscriminatorGeneratesSchemaCorrectly()
    {
    ...
    [Fact()]
    public void GenerateSchemaGenerateSchemaFromInterfaceWithDiscriminatorGeneratesSchemaCorrectly()
    {
